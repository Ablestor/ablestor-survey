...
export var StyledSwitch = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n  width: ", "px;\n  height: 20px;\n  background-color: ", ";\n  border-radius: 15px;\n  cursor: pointer;\n  transition: background-color 0.3s;\n  .switch-button {\n    position: absolute;\n    width: 20px;\n    height: 20px;\n    border-radius: 50%;\n    background-color: #fff;\n    left: ", "px;\n    box-shadow: 0 0 2px 0 rgba(0, 0, 0, 0.2);\n    transition: all 0.3s;\n  }\n"], ["\n  position: relative;\n  display: inline-block;\n  width: ", "px;\n  height: 20px;\n  background-color: ", ";\n  border-radius: 15px;\n  cursor: pointer;\n  transition: background-color 0.3s;\n  .switch-button {\n    position: absolute;\n    width: 20px;\n    height: 20px;\n    border-radius: 50%;\n    background-color: #fff;\n    left: ", "px;\n    box-shadow: 0 0 2px 0 rgba(0, 0, 0, 0.2);\n    transition: all 0.3s;\n  }\n"])), function (props) { return props.width; }, function (props) { return (props.value ? props.theme.main : props.theme.lightGray); }, function (props) { return (props.value ? (props.width || 40) - 20 : 0); });
export var StyledSelectorThumb = styled.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  position: relative;\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: grab;\n"], ["\n  position: relative;\n  width: 20px;\n  height: 20px;\n  border-radius: 50%;\n  background-color: ", ";\n  cursor: grab;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.main;
});
export var StyledSelectorValueLabel = styled.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  position: absolute;\n  width: 30px;\n  top: 30px;\n  left: -5px;\n  text-align: center;\n  font-weight: 0.8rem;\n  border-radius: 3px;\n  background-color: rgba(0, 0, 0, 0.6);\n  > p {\n    margin-bottom: 2px;\n    color: #fff;\n  }\n  &:after {\n    display: inline-block;\n    position: absolute;\n    content: '';\n    top: -5px;\n    left: 10px;\n    width: 0;\n    height: 0;\n    border-bottom: 5px solid rgba(0, 0, 0, 0.6);\n    border-left: 5px solid transparent;\n    border-right: 5px solid transparent;\n    background-color: transparent;\n  }\n"], ["\n  position: absolute;\n  width: 30px;\n  top: 30px;\n  left: -5px;\n  text-align: center;\n  font-weight: 0.8rem;\n  border-radius: 3px;\n  background-color: rgba(0, 0, 0, 0.6);\n  > p {\n    margin-bottom: 2px;\n    color: #fff;\n  }\n  &:after {\n    display: inline-block;\n    position: absolute;\n    content: '';\n    top: -5px;\n    left: 10px;\n    width: 0;\n    height: 0;\n    border-bottom: 5px solid rgba(0, 0, 0, 0.6);\n    border-left: 5px solid transparent;\n    border-right: 5px solid transparent;\n    background-color: transparent;\n  }\n"])));
