...
export declare type BlockType = 'blank' | 'short_text' | 'long_text' | 'single_select' | 'multi_select' | 'dropdown' | 'range' | 'date' | 'time';
...
export declare type Blocks = ISurveyBlankBlock | ISurveyShortTextBlock | ISurveyLongTextBlock | ISurveySingleSelectBlock | ISurveyMultiSelectBlock | ISurveyDropdownBlock | ISurveyRangeBlock | ISurveyDateBlock | ISurveyTimeBlock;
